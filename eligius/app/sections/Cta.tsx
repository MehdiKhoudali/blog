...
export default function Cta() {
	return (
		<section className="md:h-[70vh] text-center px-4 bg-white py-24 flex flex-col justify-center gap-5 md:gap-8 md:px-4">
            <h2 id="hero_h1" className="sm:leading-[1.5rem] text-center text-gray-800 font-bold text-4xl md:text-[50px]">Start now, grow your branding & scale your audience !</h2>  
