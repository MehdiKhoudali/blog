...
export default function Cta() {
	return (
		<section className="border-2 mx-4 dark:bg-white border-black rounded-md md:h-[70vh] text-center px-4 bg-white py-24 flex flex-col justify-center gap-5 md:gap-8 md:px-4">
