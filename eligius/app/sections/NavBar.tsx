    ...
    return (
        <section className="w-full items-center top-0 left-0">
            <nav className="flex justify-between px-4 md:px-12 py-2 md:py-4 items-center">
                <h2 className="text-[20px] text-gray-800 font-bold"><Image alt="Track the performances of your software team with leaderboards." className="w-[7rem] h-[4rem] md:h-[6rem] md:w-[11rem]" src={Logo} /></h2>
